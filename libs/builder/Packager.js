...
export default class Packager {
    ...
    static build(params) {
        ...
        Packager.updateCamera(attributes.camera, attributes)
    ...
    static linkScript(data, entity, scriptID, src) {
        ...
        try {
            ...
            const generator = new Function("Debug, Component, COMPONENTS, Camera", data.toString())
            try {

                const Instance = generator(Debug, Component, COMPONENTS, window.renderer.rootCamera)
