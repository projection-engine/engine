...
export default class Renderer {
    ...
    constructor( resolution ) {
        gpu = window.gpu
        Promise.all([import("./templates/CUBE"), window.imageWorker(IMAGE_WORKER_ACTIONS.IMAGE_BITMAP, {base64: BRDF, onlyData: true})]).then(async res => {
            const [cube, bitmap] = res
            console.trace(bitmap)
