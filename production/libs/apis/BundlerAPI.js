...
import ViewportEventsAPI from "./ViewportEventsAPI";
...
export default class BundlerAPI {
    ...
    static async buildWindow(canvas) {
        ...
        RendererController.cubeBuffer = new VBOInstance(1, new Float32Array(cube), gpu.ARRAY_BUFFER, 3, gpu.FLOAT)
    ...
    static linkScript(data, entity, scriptID, src) {
        ...
        try {
            ...
            const generator = new Function("ViewportEventsAPI, ConsoleAPI, Component, COMPONENTS, CameraAPI, QueryAPI", data.toString())
            try {

                const Instance = generator(ViewportEventsAPI, ConsoleAPI, Component, COMPONENTS, CameraAPI, QueryAPI)
