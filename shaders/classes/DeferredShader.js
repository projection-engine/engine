...
import {fragment, vertex} from '../resources/deferred.glsl'
...
export default class DeferredShader extends Shader {
    constructor(gpu) {
        ...
        // this.projectionMatrixUlocation = this.gpu.getUniformLocation(this.program, `projectionMatrix`)
    ...
    bindUniforms({
                     ...
                     BRDF, closestCubeMap,
                     previousFrame,ambientOcclusion,projectionMatrix
                 }) {
        ...
        // this.gpu.uniform3fv(this.projectionMatrixUlocation, projectionMatrix)
