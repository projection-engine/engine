...
import VertexBuffer from "./lib/instances/VertexBuffer";
...
export default class GPUResources {
    ...
    static async initializeContext(canvas, [width, height], readAsset) {
        ...
        GPUController.allocateFramebuffer(STATIC_FRAMEBUFFERS.CURRENT_FRAME, width, height).texture().depthTest()
        GPUController.allocateFramebuffer(STATIC_FRAMEBUFFERS.POST_PROCESSING_WORKER, width, height).texture()
