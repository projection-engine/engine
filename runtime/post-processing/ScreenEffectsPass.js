...
export default class ScreenEffectsPass {
    ...
    static initialize() {
        ...
        ScreenEffectsPass.generateBuffers(10)
    ...
    static execute() {
        ...
        //         gpu.uniform1f(blurShaderUniforms.blurRadius, 3)
        //         GPU.quad.draw()
        //         fbo.stopMapping()
        //     }
        //
        ...
        //         gpu.bindTexture(gpu.TEXTURE_2D, downscale[downscale.length - i -1].colors[0])
        //         gpu.uniform1i(upSamplingShaderUniforms.blurred, 1)
        //         gpu.uniform1f(upSamplingShaderUniforms.sampleScale, window.inD || 3)
        //         GPU.quad.draw()
        //         fbo.stopMapping()
        //     }
