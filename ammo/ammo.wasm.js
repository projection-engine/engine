...
const PATH_TO_WASM = __dirname + path.sep + "build" + path.sep + "ammo.wasm.wasm"
...
function Ammo() {
    ...
    return "undefined" != typeof __filename && (t = t || __filename), function (e) {
        ...
        "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node ? (y = b ? require("path").dirname(y) + "/" : __dirname + "/", a = (() => {
            c || (s = require("fs"), c = require("path"))
        }), i = function (t, e) {
