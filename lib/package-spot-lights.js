...
export function packageSpotLights(keepOld) {
    const spotLights = LightsAPI.spotLights.array
    ...
    for (let i = 0; i < spotLights.length; i++) {
        ...
        const positionToLight = vec3.add([], position, component.direction)
        const rotatedDirection = vec3.transformQuat([], positionToLight, current._rotationQuat)
        ...
        buffer[11 + offset] = component.cutoff
