...
static atlasRatio = 0
    static initialize() {
        ...
        ShadowMapPass.shadowMapShader = GPUController.allocateShader(STATIC_SHADERS.PRODUCTION.DIRECT_SHADOWS, smShaders.vertex, smShaders.fragment)
        ShadowMapPass.shadowMapOmniShader = GPUController.allocateShader(STATIC_SHADERS.PRODUCTION.OMNIDIRECTIONAL_SHADOWS, smShaders.vertex, smShaders.omniFragment)
    ...
    static allocateData() {
        ...
        ShadowMapPass.shadowsFrameBuffer = GPUController.allocateFramebuffer(STATIC_FRAMEBUFFERS.SHADOWS, ShadowMapPass.maxResolution, ShadowMapPass.maxResolution)
        ...
        DeferredPass.deferredUniforms.shadowCube0 = ShadowMapPass.cubeMaps[0].texture
        DeferredPass.deferredUniforms.shadowCube1 = ShadowMapPass.cubeMaps[1].texture
    }
