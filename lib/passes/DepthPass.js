...
import DEPTH_PASSGlsl from "../../templates/shaders/DEPTH_PASS.glsl";
...
export default class DepthPass {
    ...
    static initialize() {
        ...
        DepthPass.normalShader =  GPUController.allocateShader(STATIC_SHADERS.PRODUCTION.NORMAL_RECONSTRUCTION, shaderCode.vertex, DEPTH_PASSGlsl.normalReconstructionFragment)
    }
